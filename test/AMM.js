...
describe('AMM', () => {
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy('MCH Media Group Token', 'MCHT', '1000000')
  ...
  describe('Swapping tokens', () => {
    ...
    it('facilitates swaps', async () => {
      ...
      expect(await amm.shares(deployer.address)).to.equal(tokens(100)) // use tokens helpler to calculate shares
